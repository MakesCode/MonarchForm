...
import { ParsedField, ParsedSchema, Renderable, SchemaProvider, FieldConfig as BaseFieldConfig } from '@autoform/core';
...
export type FieldConfig<FieldTypes = string, CustomData = Record<string, any>> = BaseFieldConfig<ReactNode, FieldTypes, React.ComponentType<FieldWrapperProps>, CustomData>;
